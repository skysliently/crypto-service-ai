...
class Sm2ServiceTest {
    ...
    void testGenerateKeyPair() throws Exception {
        ...
        String publicKeyHex = sm2Service.getPublicKeyHex(keyPair.getPublic());
        String privateKeyHex = sm2Service.getPrivateKeyHex(keyPair.getPrivate());
    ...
    void testKeySerializationAndRestoration() throws Exception {
        ...
        // Serialize keys
        String publicKeyHex = sm2Service.getPublicKeyHex(originalPublicKey);
        String privateKeyHex = sm2Service.getPrivateKeyHex(originalPrivateKey);
    ...
    void testEncryptionAndDecryption() throws Exception {
        ...
        String privateKeyHex = sm2Service.getPrivateKeyHex(privateKey);
        String publicKeyHex = sm2Service.getPublicKeyHex(publicKey);
